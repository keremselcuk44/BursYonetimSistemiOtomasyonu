...
namespace OgrenciBursOtomasyonu.Desktop.Controls
{
    /// <summary>
    /// Buton paneli kontrolü. DevExpress editör butonlarını panel olarak yönetir.
    /// </summary>
    ...
    /// <summary>
    /// Buton paneli event sağlayıcısı. Mouse event'lerini yönetir.
    /// </summary>
    ...
    /// <summary>
    /// Buton paneli bilgisi. Butonların görsel durumunu ve konumlarını yönetir.
    /// </summary>
