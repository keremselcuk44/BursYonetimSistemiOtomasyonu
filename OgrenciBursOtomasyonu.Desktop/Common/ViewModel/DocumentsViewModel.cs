...
namespace OgrenciBursOtomasyonu.Desktop.Common.ViewModel
{
        ...
        where TUnitOfWork : IUnitOfWork
    {
        ...
        // TODO: Implement when DocumentManagerService events are wired up
        /*
        ...
        */
        ...
        protected virtual IDocument CreateDocument(TModule module)
        {
        ...
        {
            // TODO: Implement when PeekCollectionViewModel is ready
            var peekViewModel = module.CreatePeekCollectionViewModel();
            var document = WorkspaceDocumentManagerService.CreateDocument("PeekCollectionView", peekViewModel);
            document.Title = module.ModuleTitle;
            return document;
        }

        // TODO: Implement PeekCollectionViewModel when needed
        /*
