namespace OgrenciBursOtomasyonu.Api.Services
{
    ...
    public class ReportInfo<TParametersViewModel> : IReportInfo
    {
        ...
        private readonly Func<TParametersViewModel, object> _reportFactory;
        ...
        public ReportInfo(TParametersViewModel parametersViewModel, Func<TParametersViewModel, object> reportFactory)
        {
        ...
        /// </summary>
        /// <returns>Oluşturulmuş rapor</returns>
        object IReportInfo.CreateReport()
        {
            return _reportFactory(_parametersViewModel) ?? throw new InvalidOperationException("Rapor oluşturulamadı.");
        }
    }
}
